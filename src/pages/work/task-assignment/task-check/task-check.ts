        ...
        buttons: [
            {
              ...
              handler: () => {
                if(!res.code){
                  this.navCtrl.push('DoingDetailPage',{id:this.id, tab:true});
                }
              }
            }
          ]
        ...
        buttons: [
            {
              text: '确认',
              handler: () => {
                setTimeout(() => this.navCtrl.push('DoingDetailPage',{id:this.id,tab:true}),2000)
              }
            }
          ]
        });
        ...
        buttons: [
            {
              text: '确认',
              handler: () => {
                  this.navCtrl.push('DoingDetailPage',{tab:true});
              }
            }
          ]
        });
